  ...
  return (
    <div className='mx-auto'>
      <div className='bg-purple min-h-screen w-90'>
        <Grid container>
          <Grid item xs={12} sm={6} className='h-screen overflow-hidden flex justify-center items-center '  >
            <img className='w-80 max-h-auto' src="https://r.resimlink.com/gqN9f.png" alt="" />
          </Grid>
          <Grid item  xs={12} sm={6}>
            <div className='px-4 sm:px-20 flex flex-col justify-center h-full'>
